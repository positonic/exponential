...
1. Open the **Create Action** or **Edit Action** modal
...
1. Open the **Create Action** or **Edit Action** modal
2. Click the **Epic** button
3. Browse or search your epics
4. Select the epic you want
...
- [Learn about Actions](/docs/features/actions) — The building blocks inside epics
- [Learn about Projects](/docs/features/projects) — Organize epics within projects
- [Learn about Sprint Planning](/docs/features/actions#sprint-assignment) — Assign actions to sprints
