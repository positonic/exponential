          ...
          {isLoading ? (
            ...
            <Stack align="center" py="xl">
              ...
              <Text c="dimmed" ta="center">
                Create your first API key to start using the API with integrations and webhooks
              </Text>
            </Stack>
          )}
        </Paper>
                ...
                <>
                  ...
                  <Select
                    ...
                    data={[
                      ...
                      { value: 'jwt', label: 'JWT Token - For MCP servers and API clients' },
                    ]}
                  ...
                  >
                    {form.values.type === 'hex'
                      ...
                      : 'JWT tokens are used for API clients and MCP server integrations. They are signed and include your user information for authentication.'
                    }
                  </Alert>
                ...
                <>
                  ...
                  >
                    {generateToken.data?.type === 'jwt'
                      ? 'Your JWT token has been generated. Use this for MCP servers and API client authentication.'
