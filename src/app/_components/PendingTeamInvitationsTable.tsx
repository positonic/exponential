...
interface PendingTeamInvitationsTableProps {
  teamId: string;
  canManage: boolean;
}

export function PendingTeamInvitationsTable({
  teamId,
  canManage,
}: PendingTeamInvitationsTableProps) {
  const utils = api.useUtils();

  const { data: invitations, isLoading } =
    api.team.listInvitations.useQuery({ teamId });
          ...
          {invitations.map((invitation) => {
            ...
            return (
              <Table.Tr key={invitation.id}>
                ...
                <Table.Td>
                  <Badge
                    color={invitation.role === "admin" ? "blue" : "gray"}
                    variant="light"
                  >
                    {invitation.role}
                  </Badge>
